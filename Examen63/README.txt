...
a persistence unit "Examen63PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Examen63/pom.xml":
...
artifact ("Examen63.war") is already built. You can build
